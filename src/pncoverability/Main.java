...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (fileChooser.showOpenDialog(parent) == JFileChooser.APPROVE_OPTION) {
			...
			System.out.println("Zvolená petriho sieť obsahuje " + net.countPlaces() + " miest(a) a " + net.countTransitions() + " prechod(y/ov)");
			//net.getReachabilityTree();
			System.out.println("Je ohraničená? " + net.getBoundedness());
			//net.printPlaces();
